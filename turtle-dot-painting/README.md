...
3. Open the terminal and navigate to the project directory
   ...
   `cd 100-days-of-code/turtle-dot-painting`
...
7. 1. Run the first couple challenges by running the command (don't forget to uncomment the specific challenge in the main.py file that you want to run first.)
